<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Users/macbookpro/Documents/www/learn/company/public/../application/admin/view/product/edit.html";i:1561598614;s:90:"/Users/macbookpro/Documents/www/learn/company/public/../application/admin/view/header.html";i:1561536900;s:88:"/Users/macbookpro/Documents/www/learn/company/public/../application/admin/view/menu.html";i:1508518240;s:90:"/Users/macbookpro/Documents/www/learn/company/public/../application/admin/view/footer.html";i:1508518240;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('product/doEdit'); ?>" method="post" enctype='multipart/form-data'>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>外包材质：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="" name="length" value="<?php echo $product['length']; ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>软管直径：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="" name="diameter" value="<?php echo $product['diameter']; ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>接头类型：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="" name="connector" value="<?php echo $product['connector']; ?>">
            </div>
        </div>
        <div class="row cl">
